		...
		<div id="principal">
            ...
            <?php
                ...
                if($sentencia=mysqli_prepare($link, $query)){
                    ...
                    mysqli_stmt_bind_result($sentencia, $idIncidente, $incPadre, $estatus, $participacion, $fecha, $diasProceso, $areaResolutora, $nombre);
                    ...
                    echo        "<tr>";
                    echo            "<th>Incidente</th><th>INC Padre</th><th>Estatus</th><th>Acción</th><th>fecha de Acción</th>
